...
| *        |
##### * Остальные параметры соответствуют параметрам виджета `text`, кроме параметра `text`.
...
| Параметр | Описание                                                                                                                  | Пример                                         | По умолчанию               |
|----------|---------------------------------------------------------------------------------------------------------------------------|------------------------------------------------|----------------------------|
| format   | Формат-строка, включающая информацию о пользователе и его статистике. Аргументы должны быть заключены в фигурных скобках. | "Лучший комментатор: {first_name} {last_name}" | "{first_name} {last_name}" |
