...
| Параметр | Описание                                                                                                      | Пример                                                 | По умолчанию                             |
|----------|---------------------------------------------------------------------------------------------------------------|--------------------------------------------------------|------------------------------------------|
| texts    | Виджет `TextSet` с аргументами*.                                                                              | ["text": "{day} {month_rus} {hoar}:{minute}:{second}"] | []                                       |
...
| Параметр | Описание                                                                                            | Примеры                                             | По умолчанию                  |
|----------|-----------------------------------------------------------------------------------------------------|-----------------------------------------------------|-------------------------------|
| texts    | Виджет `TextSet` с аргументами*.                                                                    | ["text": "Количество подписчиков: {members_count}"  | []                            |
...
| info                   | Информация о периоде*.                                                                                                                                                                                             | {"text": "Рейтинг с {date_from} по {date_to}"} | {}                                     |

##### * Информация о периоде
| Параметр  | Описание                                                   | Пример                                         | По умолчанию                     |
|-----------|------------------------------------------------------------|------------------------------------------------|----------------------------------|
| texts     | Виджет `TextSet` с аргументами: `date_from`, `date_to`     | {"text": "Рейтинг с {date_from} по {date_to}"} | {}                               | 
| date_from | Виджет `Date`. Указывает на период начала рейтинга.        | {"texts": "{day} {month_rus}" }                | {"texts": "{day}.{month}.{year}} | 
| date_to   | Виджет `Date`. Указывает на период конца рейтинга.         | {"texts": "{day} {month_rus}" }                | {"texts": "{day}.{month}.{year}} |
...
| Параметр      | Описание                                                     | Пример                                                    | По умолчанию   |
|---------------|--------------------------------------------------------------|-----------------------------------------------------------|----------------|
| texts         | Виджета `TextSet` с аргументами*.                            | ["text": "Лучший комментатор: {first_name} {last_name}"]  | []             |
| avatar**      | Аватарка пользователя.                                       | {"xy": [30, 45], "resize": [100, 100]}                    | None - без авы |
...
| default_path      | Путь до фотографии по умолчанию. Используется, если место не занято или у пользователя отсутствует аватар.                                                    | "path/img.png"            | None         |
| default_url       | URL фотографии по умолчанию. Игнорируется, если установлен `default_path`.                                                                                    | "https://example/img.png" | None         |
| random_images_dir | Если установлен, выбирает для пользователя картинку из директории по следующей формуле: `user_id` % `N`, где `N` - количество картинок в директории.          | "path/imgs                | None         |
| *                 |                                                                                                                                                               |                           |              |
