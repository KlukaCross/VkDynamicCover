...
| app_id (необязательно)       | Идентификатор приложения Вконтакте. Требуется, если включен виджет `Subcriber`.                                                                                                                                                                                                                                                                                                                                                                                                                                                   | 123123123                                                         |
| donate_key (необязательно)   | Ключ от приложения "Таноды". Необходим для получения списка донатеров в виджете `Subcriber`.                                                                                                                                                                                                                                                                                                                                                                                                                                      | "asd2dja2"                                                        |
...
3. month_rus_r* - название месяца в родительном падеже ("января", "декабря");
4. week - номер дня недели (1 - понедельник, 7 - воскресенье);
5. week_rus* - название дня недели ("понедельник", "воскресенье");
6. day - день месяца;
7. hour - часы;
8. minute - минуты;
9. second - секунды.
