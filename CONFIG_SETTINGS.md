...
| Параметр  | Описание                                                        | Пример                                         | По умолчанию                     |
|-----------|-----------------------------------------------------------------|------------------------------------------------|----------------------------------|
| text      | Виджет `Text` со следующими параметрами: `date_from`, `date_to` | {"text": "Рейтинг с {date_from} по {date_to}"} | {}                               | 
...
| default_texts | Список виджета `TextSet`. Применяется, если место не занято. | ["text": "Лучшего комментатора нет!"]                     | []             |
