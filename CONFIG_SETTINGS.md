...
|--------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|--------------|
| text         | Текст, который нужно отобразить. В тексте можно задать параметры `{vspace(N)}` и `{hspace(N)}`, на месте которых вставится пустое пространство длины N пикселей по вертикали и горизонтали соответственно                            | "my text \n my {vspace(10)} text2" | ""           |
