...
| widget_program (необязательно) | Используется, если вы хотите переключать наборы виджетов друг за другом.                                                                                                                                                                                                                                                                                                                                                                                                                                                          | ["widget_set1", "widget_set2"]                                    |
...
###### Программа виджетов
Если есть виджеты с другими именами, то их следует включить в поле `widget_program`.
Если в список программы виджетов включено несколько наборов, то они будут отрисовываться друг за другом подобно программам на телевизору.
...
| Параметр | Описание                                                                                                                  | Пример                                       | По умолчанию                             |
|----------|---------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|------------------------------------------|
| format   | Формат-строка, включающая информацию о дате и времени. Аргументы даты и времени должны быть заключены в фигурных скобках. | "{day} {month_rus} {hoar}:{minute}:{second}" | "{day} {month_rus} {year}"               |
...
| *        |
##### * Остальные параметры соответсвуют параметрам виджета `text`, кроме параметра `text`.
...
***
### Виджет random_picture
Предназначен для отображения рандомной картинки.

| Параметр      | Описание                                                                                                                                                                                      | Пример       | По умолчанию |
|---------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|
| path          | Путь до директории с картинками.                                                                                                                                                              | "/path/pics" | None         |
| from_group_id | Идентификатор сообщества, из альбома которого будут браться картинки.                                                                                                                         | -123456789   | None         |
| from_album_id | Идентификатор альбома, из которого будут браться картинки. Возможны отрицательные значения для сервисных альбомов. Если установлен `path`, то `from_group_id` и `from_album_id` игнорируются. | 12345123     | None         |
| *             |
##### * Остальные параметры соответсвуют параметрам виджета `picture`, кроме параметра `url` и `path`.
...
| Параметр | Описание                                                                                                          | Примеры                                   | По умолчанию |
|----------|-------------------------------------------------------------------------------------------------------------------|-------------------------------------------|--------------|
| format   | Формат-строка, включающая информацию о статистике. Аргументы статистики должны быть заключены в фигурных скобках. | "Количество подписчиков: {members_count}" | ""           |
...
| point_weights  | Вес очков в формате `{позиция: вес}`, которые даются за каждую из позиций (лайк, коммент, репост). Возможные позиции: `like`, `comment`, `repost`.                                                                 | {"like": 1, "comment": 2, "repost": 3} | {"like": 0, "comment": 0, "repost": 0} |
| like_places    | Массив из `MemberPlace` рейтинга по лайкам.                                                                                                                                                                        | [..., ...]                             | []                                     |
| repost_places  | Массив из `MemberPlace` рейтинга по репостам.                                                                                                                                                                      | [..., ...]                             | []                                     |
| comment_places | Массив из `MemberPlace` рейтинга по комментам.                                                                                                                                                                     | [..., ...]                             | []                                     |
| point_places   | Массив из `MemberPlace` собственного рейтинга на основе `point_weights`.                                                                                                                                           | [..., ...]                             | []                                     |
| lastSub_places | Массив из `MemberPlace` последних подписчиков.                                                                                                                                                                     | [..., ...]                             | []                                     |
...
| Параметр | Описание                                                                                                               | Пример                                         | По умолчанию               |
|----------|------------------------------------------------------------------------------------------------------------------------|------------------------------------------------|----------------------------|
| format   | Формат-строка, включающая информацию о пользователе. Аргументы должны быть заключены в фигурных скобках.               | "Лучший комментатор: {first_name} {last_name}" | "{first_name} {last_name}" |
| picture  | Информация, где будет расположена аватарка пользователя. См. параметры виджета `picture` за исключением `path` и `url` | {"xy": [30, 45], "resize": [100, 100]}         | {}                         |
| *        |                                                                                                                        |                                                |                            |
